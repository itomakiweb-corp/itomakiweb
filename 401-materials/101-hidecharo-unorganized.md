...
1. 褒める方法、自分を過小評価するのはやめる　自分のことは自分でなら褒める　自分も褒めるし、相手も褒める
1. 自分を褒められない人は、相手を褒められない
1. 少しでも、できることがあったら、褒めてあげる
1. 褒めの続き、褒め方。褒めるのは大事です。という返答はずれている。できたことは必ず褒める
1. できたことと、0から1になったことを褒めましょう
...
- 官公庁だと、よくあるけど、古い主流である、Solarisが使われたりする
- Oracle, Solarisなど統一
- 提案、構築、実装など一通り、触った
- ネットワークSE的な働き方
- 減価償却の終わった余ったサーバを使って、データセンターを作りたい
- ML系のサービス
